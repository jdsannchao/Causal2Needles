...
declare -a tasks=("2needle_vision" "2needle_normal" "2needle_rev" "1needle" "1needle_noncausal")
declare -A prompts=(
  ...
  ["1needle_noncausal"]="prompts/test/test_prompt_1needle.txt"
)
declare -A scripts=(
  ...
  ["1needle_noncausal"]="test_VLM_1needle_NC.py"
)
